...
const topUsers = [
  { uid: '00000584', usdt: '4569.38' },
  { uid: '00004418', usdt: '3749.63' },
  { uid: '00006437', usdt: '3453.82' },
];

function StickyStats({ tabRefs, tabs }: StickyStatsProps) {
  const monthLabels = getLastFiveMonths();

  const amounts = ['33만원', '48만원', '104만원', '150만원', '98만원'];
  const heightClasses = ['h-8', 'h-13', 'h-32', 'h-45', 'h-30'];
  ...
  return (
    <div
      ...
      className="my-6 py-6"
    >
      <h2 className="mb-6">Gate 통계 데이터</h2>
