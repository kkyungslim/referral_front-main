  ...
  return (
    <section>
      <div className="container mx-auto">
        <h2 className={'my-6 font-bold'}>Bybit</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-20">
          <div>
            ...
            >
              <h3 className={'text-primary font-bold'}>40%</h3>
              <div
          ...
          <div>
            ...
            <div className={'w-full mt-5'}>
              <div className={''}>
                ...
                <h4 className={'text-primary font-bold text-right'}>0.0096%</h4>
              </div>
              <div className={'mt-4'}>
                <h5 className={'text-left text-front2'}>
                ...
                <h4 className={'text-primary font-bold text-right'}>0.0264%</h4>
              </div>
            </div>
          </div>
          <div className={''}>
