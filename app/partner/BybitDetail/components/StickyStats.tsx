...
function StickyStats({ tabRefs, tabs }: StickyStatsProps) {
  ...
  const amounts = ['27만원', '23만원', '28만원', '28만원', '27만원'];
  const heightClasses = ['h-35', 'h-30', 'h-40', 'h-40', 'h-35'];
  ...
  const topUsers = [
    { uid: '00001834', usdt: '269.38' },
    { uid: '00009428', usdt: '249.63' },
    { uid: '00003187', usdt: '153.82' },
  ];
  return (
    <div
      ref={(el) => {
      ...
      className="my-6 py-6"
    >
      <h2 className="mb-6">Bybit 통계 데이터</h2>
