...
function StickyStats({ tabRefs, tabs }: StickyStatsProps) {
  ...
  const amounts = ['1만원', '1만원', '1만원', '4만원', '15만원'];
  const heightClasses = ['h-5', 'h-5', 'h-5', 'h-20', 'h-50'];
  ...
  const topUsers = [
    { uid: '00003282', usdt: '153.25' },
    { uid: '00007129', usdt: '141.12' },
    { uid: '00009135', usdt: '114.84' },
  ];
  return (
    <div
      ref={(el) => {
      ...
      className="my-6 py-6"
    >
      <h2 className="mb-6">HTX 통계 데이터</h2>
