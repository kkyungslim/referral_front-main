...
import CameraCapture from '@/app/kyc/HTXSecureKYCVerification/components/CameraCapture';
import IDVerification from '@/app/kyc/HTXSecureKYCVerification/components/IDVerification';
import VerificationCompletion from '@/app/kyc/HTXSecureKYCVerification/components/VerificationCompletion';

function HTXSecureKYCVerificationPage() {
  const tabData = [
    {
      value: 'idCard',
      title: '기본 정보 입력',
...
export default HTXSecureKYCVerificationPage;
