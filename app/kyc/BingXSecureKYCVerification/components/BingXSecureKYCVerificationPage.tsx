...
import CameraCapture from '@/app/kyc/BingXSecureKYCVerification/components/CameraCapture';
import IDVerification from '@/app/kyc/BingXSecureKYCVerification/components/IDVerification';
import VerificationCompletion from '@/app/kyc/BingXSecureKYCVerification/components/VerificationCompletion';

function BingXSecureKYCVerificationPage() {
  const tabData = [
    {
      value: 'idCard',
      title: '신분증 인증',
...
export default BingXSecureKYCVerificationPage;
