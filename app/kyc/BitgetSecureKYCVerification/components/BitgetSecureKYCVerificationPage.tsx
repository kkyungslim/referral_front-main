...
import CameraCapture from '@/app/kyc/BitgetSecureKYCVerification/components/CameraCapture';
import IDVerification from '@/app/kyc/BitgetSecureKYCVerification/components/IDVerification';
import VerificationCompletion from '@/app/kyc/BitgetSecureKYCVerification/components/VerificationCompletion';

function BitgetSecureKYCVerificationPage() {
  const tabData = [
    {
      value: 'idCard',
      title: '신분증 인증',
...
export default BitgetSecureKYCVerificationPage;
