...
import CameraCapture from '@/app/kyc/BybitSecureKYCVerification/components/CameraCapture';
import IDVerification from '@/app/kyc/BybitSecureKYCVerification/components/IDVerification';
import VerificationCompletion from '@/app/kyc/BybitSecureKYCVerification/components/VerificationCompletion';

function BybitSecureKYCVerificationPage() {
  const tabData = [
    {
      value: 'idCard',
      title: '신분증 인증',
...
export default BybitSecureKYCVerificationPage;
