    ...
    <section className={'bg-bg1'}>
      <div className="container mx-auto py-15">
        ...
        <div className={'flex flex-col gap-4 mt-10'}>
            ...
            <Card className={'flex-row justify-between items-center'}>
              <div className="flex items-start gap-1">
                ...
                <div className={'flex flex-col'}>
                  ...
                  <p
                    className={'md:text-sm text-xs  text-front2 font-semibold'}
                  >
                    Bitget 레퍼럴 코드 확인하기
                  </p>
                </div>
          ...
          <Link href={'/kyc/BitgetSignUpGuide'}>
            <Card className={'flex-row justify-between items-center'}>
              <div className="flex items-start gap-1">
                <p className={'font-bold text-primary md:text-lg text-sm'}>
                  3.
          ...
          <Link href={'/kyc/BitgetKYCVerificationButton'}>
            <Card className={'flex-row justify-between items-center'}>
              <div className="flex items-start gap-1">
                <p className={'font-bold text-primary md:text-lg text-sm'}>
                  4.
          ...
          <Link href={'/kyc/BitgetSecureKYCVerification'}>
            <Card className={'flex-row justify-between items-center'}>
              <div className="flex items-start gap-1">
                <p className={'font-bold text-primary md:text-lg text-sm'}>
                  5.
...
export default BitgetAccountFAQPage;
