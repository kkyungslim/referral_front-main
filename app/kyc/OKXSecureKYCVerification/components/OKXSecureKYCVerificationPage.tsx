...
import CameraCapture from '@/app/kyc/OKXSecureKYCVerification/components/CameraCapture';
import IDVerification from '@/app/kyc/OKXSecureKYCVerification/components/IDVerification';
import VerificationCompletion from '@/app/kyc/OKXSecureKYCVerification/components/VerificationCompletion';

function OKXSecureKYCVerificationPage() {
  const tabData = [
    {
      value: 'idCard',
      title: '신분증 인증',
...
export default OKXSecureKYCVerificationPage;
